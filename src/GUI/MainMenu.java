...
public class MainMenu extends Application {
    ...
    private static Scene getView (Stage window) {
    ...
    private static GridPane getMainPane(Stage window) {
    ...
    private static void setStyling(GridPane mainPane, Button studentButton, Button cursusButton, Button enrollButton, Button certificateButton){
    ...
    private static void createActionsForButtons(Button studentButton, Button cursusButton, Button enrollButton, Button certificateButton, Stage window) {
